...
public class AdminDashAdapter extends RecyclerView.Adapter<AdminDashAdapter.ImageViewHolder> {

    Context context;
    ArrayList<add_products_model> list;

    public AdminDashAdapter(Context context, ArrayList<add_products_model> list) {
