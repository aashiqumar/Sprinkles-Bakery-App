...
public class ConfirmedOrderAdapter extends RecyclerView.Adapter<ConfirmedOrderAdapter.ImageViewHolder> {

    Context context;
    ArrayList<add_products_model> list;

    public ConfirmedOrderAdapter(Context context, ArrayList<add_products_model> list) {
    ...
    public void onBindViewHolder(ImageViewHolder holder, int i) {
        ...
        holder.btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance().getReference("confirmed_orders").child(userid).push()
                        .setValue(map)
